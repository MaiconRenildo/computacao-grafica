...
void DefineIluminacao (void){
	...
	GLfloat luzDifusa2[4] = {0.7, 0.7, 0.7, 1.0};    // cor da luz
	GLfloat luzEspecular2[4] = {1.0, 1.0, 1.0, 1.0}; // brilho da luz
	GLfloat posicaoLuz2[4] = {luz2X, luz2Y, luz2Z, 1.0}; // posição da luz
...
void Desenha(void)
{
	...
	glNormal3f(0, 0, -1);
	// Triângulo 1
	glVertex3f( 50.0,  50.0, -50.0); // V4
	glVertex3f( 50.0, -50.0, -50.0); // V7
	glVertex3f(-50.0, -50.0, -50.0); // V6
	// Triângulo 2
	glVertex3f( 50.0,  50.0, -50.0); // V4
	glVertex3f(-50.0, -50.0, -50.0); // V6
	glVertex3f(-50.0,  50.0, -50.0); // V5
	glEnd();

	// Face lateral direita (X positivo)
	glBegin(GL_TRIANGLES);
	glNormal3f(1, 0, 0);
	// Triângulo 1
	glVertex3f( 50.0,  50.0,  50.0); // V0
	...
	// Face lateral esquerda (X negativo)
	glBegin(GL_TRIANGLES);
	glNormal3f(-1, 0, 0);
	// Triângulo 1
	glVertex3f(-50.0,  50.0,  50.0); // V1
...
void Inicializa(void){
	...
	glEnable(GL_LIGHT0);
	glEnable(GL_LIGHT1); // ultima questão
...
void Teclado(unsigned char key, int x, int y)
{
    switch (key)
    {
        ...
        case 'p' : case 'P' :
         ...
         case 'b' : case 'B' :
			...
			std::cout << "Specular Material: " << especMaterial << std::endl;
            break;
		case 'x': luz2X -= 5.0f; break;
		case 's': luz2X += 5.0f; break;
		case 'c': luz2Y -= 5.0f; break;
		case 'd': luz2Y += 5.0f; break;
		case 'v': luz2Z -= 5.0f; break;
		case 'f': luz2Z += 5.0f; break;
	...
	std::cout << "Posição da Luz 2 -> X: " << luz2X
          << " Y: " << luz2Y
          << " Z: " << luz2Z << std::endl;
